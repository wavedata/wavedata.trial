...
function Register() {
        ...
        if (type === 1) {
            if (typeof window.tronLink !== "undefined") {
                ...
                if (window?.tronWeb?.defaultAddress?.base58 != null) {
                    ...
                    window.localStorage.setItem("type", "tronlink")
            ...
            window.localStorage.setItem("type", "non-tronlink")
    ...
    useEffect(() => {
        if (typeof window.tronLink !== "undefined") {
            if (window.tronLink.tronWeb !== false && window.localStorage.getItem("type") === "tronlink") {
                setisTronConnected(true);
            } else {
                setisTronConnected(false);
            }
