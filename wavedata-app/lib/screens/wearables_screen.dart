...
class _WearablesScreenState extends ConsumerState<WearablesScreen> {
  ...
  Future<void> generateLoginLink() async {
    var url = Uri.parse(
        'https://wavedatatrial-api.netlify.app/api/GET/Wearable/getSourceLink?userid=${userid}');
    final response = await http.get(url);
    var responseData = json.decode(response.body);
  ...
  Future<void> GetBloodRate() async {
    ...
    var url = Uri.parse(
        'https://wavedatatrial-api.netlify.app/api/GET/Wearable/customAPI?userid=${userid}&url=https://api.und-gesund.de/v5/dailyDynamicValues&token=${this.AccountTokenAddress}&body_startDay=${startDate}&body_endDay=${endDate}&body_valueTypes=3001');
    final response = await http.get(url);
    var responseData = json.decode(response.body);
  ...
  Future<void> GetSleepData() async {
    ...
    // var url = Uri.parse(
    //     'https://wavedatatrial-api.netlify.app/api/GET/Wearable/customAPI?userid=${userid}&url=https://api.und-gesund.de/v5/dailyDynamicValues&token=${this.AccountTokenAddress}&body_startDay=${startDate}&body_endDay=${endDate}&body_valueTypes=2002,2003,2005');
    var url = Uri.parse(
        'https://wavedatatrial-api.netlify.app/api/GET/Wearable/customAPI?userid=${userid}&url=https://api.und-gesund.de/v5/dailyDynamicValues&token=${this.AccountTokenAddress}&body_startDay=${startDate}&body_endDay=${endDate}&body_valueTypes=2001');
    final response = await http.get(url);
    var responseData = json.decode(response.body);
    var parsed = json.decode(responseData['value']);
    var onedate = 0;
  ...
  Future<void> GetStepsData() async {
    ...
    // var endDate = DateFormat('yyyy-MM-dd').format(new DateTime(2023,01,17));
    var url = Uri.parse(
        'https://wavedatatrial-api.netlify.app/api/GET/Wearable/customAPI?userid=${userid}&url=https://api.und-gesund.de/v5/dailyDynamicValues&token=${this.AccountTokenAddress}&body_startDay=${startDate}&body_endDay=${endDate}&body_valueTypes=1000');
    final response = await http.get(url);
    var responseData = json.decode(response.body);
    var parsed = json.decode(responseData['value']);
    for (var i = 0; i < parsed[0]['dataSources'][0]['data'].length; i++) {
  ...
  Future<void> GetCaloriesData() async {
    ...
    // var endDate = DateFormat('yyyy-MM-dd').format(new DateTime(2023,01,17));
    var url = Uri.parse(
        'https://wavedatatrial-api.netlify.app/api/GET/Wearable/customAPI?userid=${userid}&url=https://api.und-gesund.de/v5/dailyDynamicValues&token=${this.AccountTokenAddress}&body_startDay=${startDate}&body_endDay=${endDate}&body_valueTypes=1010');
    final response = await http.get(url);
    var responseData = json.decode(response.body);
    var parsed = json.decode(responseData['value']);
    for (var i = 0; i < parsed[0]['dataSources'][0]['data'].length; i++) {
  ...
  Future<dynamic> GetDevices() async {
    var url = Uri.parse(
        'https://wavedatatrial-api.netlify.app/api/GET/Wearable/customAPI?userid=${userid}&url=https://api.und-gesund.de/v5/userInformation&token=${this.AccountTokenAddress}');
    final response = await http.get(url);
    var responseData = json.decode(response.body);
    setState(() {
